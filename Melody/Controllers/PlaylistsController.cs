...
namespace Melody.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlaylistId,Name,UserId")] Playlist playlist)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.UserDetails, "UserId", "Email", playlist.UserId);
            return View(playlist);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaylistId,Name,UserId")] Playlist playlist)
        {
